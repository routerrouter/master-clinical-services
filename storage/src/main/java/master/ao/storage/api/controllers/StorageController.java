...
public class StorageController {
    ...
    public ResponseEntity<StorageResponse> saveStorage(@Valid @RequestBody StorageRequest request,
        ...
        return Stream.of(request)
                ...
                .map(storage -> storageService.save(storage, token))
    ...
    @GetMapping
    public ResponseEntity<Page<Object>> getAll(@ParameterObject SpecificationTemplate.StorageSpec spec,
        ...
        return utilService.getPageResponseEntity(pageable, new ArrayList<Object>(storagesList));
