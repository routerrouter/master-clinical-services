...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleEntityNotFound(AccessDeniedException ex, WebRequest request) {
        ...
        ProblemType problemType = ProblemType.DENIED_ACCESS;
    ...
    public ResponseEntity<?> handleAccountLocked(AccountLockedException ex, WebRequest request) {

        HttpStatus status = HttpStatus.FORBIDDEN;
        ProblemType problemType = ProblemType.BLOCKED_ACCOUNT;
        String detail = ex.getMessage();
    ...
    public ResponseEntity<?> handleAccountExpired(AccountExpiredException ex, WebRequest request) {

        HttpStatus status = HttpStatus.FORBIDDEN;
        ProblemType problemType = ProblemType.EXPIRED_ACCOUNT;
        String detail = ex.getMessage();
    ...
    @ExceptionHandler(AccountAccessLimitException.class)
    public ResponseEntity<?> handleAccountLimitAccess(AccountAccessLimitException ex, WebRequest request) {

        HttpStatus status = HttpStatus.FORBIDDEN;
        ProblemType problemType = ProblemType.ACCOUNT_ACCESS_LIMIT;
        String detail = ex.getMessage();
